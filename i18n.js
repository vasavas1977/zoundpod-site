...
(function () {
  ...
  var TH = {
    ...
    mp_sub: "ZOUND พ็อด คือชิ้นงานหนึ่งเดียว ประณีตดั่งเฟอร์นิเจอร์ชั้นเลิศ ลอกเลียนแบบไม่ได้ และเป็นสิ่งที่คุณภูมิใจได้เต็มหัวใจ วางไว้ในออฟฟิศเมื่อใด ทั้งห้องก็ดูพรีเมียมขึ้นทันที",
    ...
    mp_cta_title: "มาเห็น มาฟัง<br/>แล้วค่อยเลือก",
    mp_cta_sub: "มาเพียงครั้งเดียว แล้วคำตอบจะชัดเจนเอง",
    mp_cta_visit: "นัดเข้าชมแบบส่วนตัว",
    mp_cta_talk: "ปรึกษาฝ่ายขาย",

    // showroom page
    sr_eyebrow: "โชว์รูม ZOUND",
    sr_title: "มาฟัง<br/>ความเงียบด้วยตัวคุณเอง",
    sr_sub: "สเปกบอกได้เพียงตัวเลข มีเพียงหูของคุณเองเท่านั้นที่พิสูจน์ความเงียบของ ZOUND ได้",
    sr_exp_eyebrow: "สัมผัสประสบการณ์จริง",
    sr_exp_title: "ก้าวเข้าไป ปิดประตู<br/>แล้วได้ยินออฟฟิศเงียบหายไป",
    sr_exp_sub: "บางอย่างต้องสัมผัสด้วยตัวเอง ก้าวเข้าไปในพ็อด ปิดประตู แล้วฟังความเงียบที่โอบล้อม สัมผัสงานวัสดุระดับเฟอร์นิเจอร์ใต้ปลายนิ้ว นี่คือความต่างที่หน้าจอบอกไม่ได้",
    ...
    sr_gallery_title: "พื้นที่ที่ออกแบบ<br/>มาเพื่อความเงียบ",
